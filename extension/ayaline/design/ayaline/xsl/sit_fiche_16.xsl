...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/produit">
		...
		<div style="float:left; width: 310px;">
			...
			<p class="clear" style="margin-bottom:15px;"></p>
				...
				<tr><td style="padding:0 0 0 15px">
					...
					<div id="tabs">
						<ul>
							...
							<li><a href="#onglet-tarifs"><span><xsl:if test="$langue = 'de'"><xsl:attribute name="style">font-size:8px;</xsl:attribute></xsl:if><xsl:value-of select="$termeTarifs"/></span></a></li>
						...
						<div id="onglet-tarifs">
							<table cellspacing="0" width="100%">
								<xsl:for-each select="criteres/critere[(@id='851000021' or @id='851000120' or @id='851000121' or @id='851000122' or @id='851000123' or @id='851000124' or @id='851000125' or @id='851000126' or @id='851000127' or @id='851000128' or @id='851000129' or @id='851000130' or @id='851000131' or @id='851000132' or @id='851000133' or @id='851000134' or @id='851000135' or @id='851000136' or @id='851000137' or @id='851000138' or @id='851000139' or @id='851000140') and ($modeAffichageCriteres = 'afficher_tout' or ($modeAffichageCriteres = 'afficher' and contains($criteresAffiches, concat('|', @id, '|'))) or ($modeAffichageCriteres = 'pas_afficher' and not(contains($criteresNonAffiches, concat('|', @id, '|')))) or count(modalites/modalite[$modeAffichageCriteres = 'afficher_tout' or ($modeAffichageCriteres = 'afficher' and contains($criteresAffiches, concat('|', @id, '|'))) or ($modeAffichageCriteres = 'pas_afficher' and not(contains($criteresNonAffiches, concat('|', @id, '|'))) and not(contains($criteresNonAffiches, concat('|', ../../@id, '|'))))]) &gt; 0) and count(modalites/modalite[string-length(valModalite) &gt; 0]) &gt; 0]">
										...
										<xsl:if test="string-length(valModalite) &gt; 0">
											<tr>
												...
												<td>
													...
													<xsl:value-of select="valModalite"/><xsl:if test="floor(valModalite) = valModalite"> &amp;euro;</xsl:if>
												</td>
											</tr>
										</xsl:if>
									</xsl:for-each>
						...
						<div id="onglet-caracteristiques">
							<xsl:if test="count(criteres/critere[$modeAffichageCriteres = 'afficher_tout' or ($modeAffichageCriteres = 'afficher' and contains($criteresAffiches, concat('|', @id, '|'))) or ($modeAffichageCriteres = 'pas_afficher' and not(contains($criteresNonAffiches, concat('|', @id, '|')))) or count(modalites/modalite[$modeAffichageCriteres = 'afficher_tout' or ($modeAffichageCriteres = 'afficher' and contains($criteresAffiches, concat('|', @id, '|'))) or ($modeAffichageCriteres = 'pas_afficher' and not(contains($criteresNonAffiches, concat('|', @id, '|'))) and not(contains($criteresNonAffiches, concat('|', ../../@id, '|'))))]) &gt; 0]) &gt; 0">
								<table cellspacing="0" width="100%">
									<xsl:for-each select="criteres/critere[($modeAffichageCriteres = 'afficher_tout' or ($modeAffichageCriteres = 'afficher' and contains($criteresAffiches, concat('|', @id, '|'))) or ($modeAffichageCriteres = 'pas_afficher' and not(contains($criteresNonAffiches, concat('|', @id, '|')))) or count(modalites/modalite[$modeAffichageCriteres = 'afficher_tout' or ($modeAffichageCriteres = 'afficher' and contains($criteresAffiches, concat('|', @id, '|'))) or ($modeAffichageCriteres = 'pas_afficher' and not(contains($criteresNonAffiches, concat('|', @id, '|'))) and not(contains($criteresNonAffiches, concat('|', ../../@id, '|'))))]) &gt; 0) and @id!='851000021' and @id!='851000120' and @id!='851000121' and @id!='851000122' and @id!='851000123' and @id!='851000124' and @id!='851000125' and @id!='851000126' and @id!='851000127' and @id!='851000128' and @id!='851000129' and @id!='851000130' and @id!='851000131' and @id!='851000132' and @id!='851000133' and @id!='851000134' and @id!='851000135' and @id!='851000136' and @id!='851000137' and @id!='851000138' and @id!='851000139' and @id!='851000140' and @id!=$critere-apartirde]">
