				...
				<![CDATA[
					$(function () {
						...
						<xsl:if test="$langue = 'fr'">
							<![CDATA[document.oswidget = new OsFG("OSRechercheDetail","22357-1621","fr");]]>
						</xsl:if>
						<![CDATA[
