...
<div class="contenu">
	...
	<div class="bloc-carte-google">
		...
		<a href="#" class="masquer-map lien-arrondi google-maps-actif"></a> <a
            ...
            {set-block variable="scriptInitGmap"}
                ...
                {literal}
                    ...
                    function afficherPointInteret(ptInteret,couleurTrace){
                            ...
                            infoWinContentStr +='<a href='+ptInteret['link']+' alt="'+ptInteret['name']+'" rel="external"><div class="visuel" style="background-color: '+couleurTrace+'">'+'<img src="'+ptInteret['visuel']+'">'+'</div></a>';
