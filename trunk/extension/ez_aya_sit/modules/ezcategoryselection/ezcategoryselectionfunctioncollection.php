<?php
//
// Definition of ezcategoryselectionfunctioncollection class
//
...
/*!
  \class   ezcategoryselectionFunctionCollection ezcategoryselectionfunctioncollection.php
  \ingroup eZDatatype
  \brief   
...
class ezcategoryselectionFunctionCollection
{
	/*!
	  Constructor
	 */
	function ezcategoryselectionFunctionCollection(){

	}

	function &fetchCategoryClassList($parent_class_filter = false){

		$ini = eZINI::instance('ezcategoryselection.ini');
