...
<div class="block button">
	...
	<input class="button-envoyer" type="image" src={"envoyer.png"|ezimage} name="{$prefixAttribute}_ezsurvey_store_button_{$attribute.id}" value="{'Submit'|i18n( 'survey' )}" />
</div>

{"%mark% Champs obligatoires."|i18n('survey', '', hash( '%mark%', '<strong class="required">*</strong>' ) )}
